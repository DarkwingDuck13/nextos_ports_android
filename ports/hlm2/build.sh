...
SRCS="src/main.c src/so_util.c src/imports.gen.c src/jni_shim.c src/opensles_shim.c src/android_shim.c src/util.c src/error.c src/shims.c src/hlm2_jni.c src/jni_log.c src/pthread_bridge.c"
$CC --sysroot="$SR" -I src -O2 -fPIC -fno-stack-protector -rdynamic -fuse-ld=bfd \
    -Wno-unused-parameter -Wno-unused-function -Wno-unused-variable \
    -o hlm2 $SRCS \
    -lSDL2 -lEGL -lGLESv2 -lz -ldl -lm -lpthread
echo "BUILD OK -> $(file hlm2 | cut -d, -f1-3)"
