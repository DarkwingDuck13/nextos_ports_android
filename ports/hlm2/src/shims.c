...
/* pthread_atfork: o RTLD_DEFAULT nao resolve (libc weak). Stub (nao usamos fork). */
int my_pthread_atfork(void (*p)(void), void (*pa)(void), void (*ch)(void)) { (void)p; (void)pa; (void)ch; return 0; }
...
const char *getprogname(void) { return "hlm2"; }
