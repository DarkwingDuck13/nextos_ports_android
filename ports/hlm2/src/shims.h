...
extern void *SL_IID_ENGINE_shim, *SL_IID_PLAY_shim, *SL_IID_RECORD_shim,
    ...
    *SL_IID_ANDROIDCONFIGURATION_shim, *SL_IID_VOLUME_shim;
...
int my_pthread_atfork(void (*)(void), void (*)(void), void (*)(void));
...
void __assert2_shim(const char *, int, const char *, const char *);
char *__strncpy_chk2_shim(char *, const char *, size_t, size_t, size_t);
char *__strncat_chk_shim(char *, const char *, size_t, size_t);
size_t __strlcpy_chk_shim(char *, const char *, size_t, size_t);
size_t __strlcat_chk_shim(char *, const char *, size_t, size_t);
char *__strrchr_chk_shim(const char *, int, size_t);
char *__strchr_chk_shim(const char *, int, size_t);
int __open_2_shim(const char *, int);
void __FD_SET_chk_shim(int, void *, size_t);
void __FD_CLR_chk_shim(int, void *, size_t);
int __FD_ISSET_chk_shim(int, void *, size_t);
int b_rwlock_init_shim(void *, const void *);
int kz_memcmp(const void*,const void*,size_t);size_t kz_strlen(const char*);int kz_strcmp(const char*,const char*);
const char *getprogname(void);
void setprogname(const char *);
int my_sigaction(int, const void *, void *);
int my_raise(int);
void my_abort(void);
