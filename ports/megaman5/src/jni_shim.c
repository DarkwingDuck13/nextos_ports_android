...
static char g_writable_path[512] = "/storage/roms/ports/megaman5/userdata/";
...
static void *string_for_tag(void *methodID) {
  ...
  if (methodID == &g_method_tags[MID_ASSETS_PATH]) return jni_make_string("/storage/roms/ports/megaman5/assets/");
