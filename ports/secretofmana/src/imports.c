...
/* ---- GLES1 fixed-function: o plandroid (Secret of Mana) e' um renderer ES1.1
 * (glMatrixMode/glOrthof/glColorPointer/...). Resolvidas de libGLESv1_CM
 * (=libMali no device). Declaramos extern p/ evitar conflito de headers ES1/ES2. */
extern void glMatrixMode(unsigned);
extern void glLoadIdentity(void);
extern void glPushMatrix(void);
extern void glPopMatrix(void);
extern void glOrthof(float, float, float, float, float, float);
extern void glFrustumf(float, float, float, float, float, float);
...
extern void glClipPlanef(unsigned, const float *);
extern void glShadeModel(unsigned);
extern void glColorPointer(int, unsigned, int, const void *);
extern void glVertexPointer(int, unsigned, int, const void *);
extern void glTexCoordPointer(int, unsigned, int, const void *);
extern void glEnableClientState(unsigned);
extern void glDisableClientState(unsigned);
extern void glPointSize(float);
/* FBO OES (ES1 extension). Resolvidas por dlsym/eglGetProcAddress em runtime
 * pois nem sempre exportadas diretamente; ver som_gl_oes_init(). */
static void (*p_glGenFramebuffersOES)(int, unsigned *);
static void (*p_glBindFramebufferOES)(unsigned, unsigned);
static void (*p_glDeleteFramebuffersOES)(int, const unsigned *);
static void (*p_glFramebufferTexture2DOES)(unsigned, unsigned, unsigned, unsigned, int);
...
static void (*p_glDeleteRenderbuffersOES)(int, const unsigned *);
static void (*p_glRenderbufferStorageOES)(unsigned, unsigned, int, int);
static void (*p_glFramebufferRenderbufferOES)(unsigned, unsigned, unsigned, unsigned);
static void (*p_glBlendEquationOES)(unsigned);
extern void *eglGetProcAddress(const char *);
static void *gl_oes(const char *n) {
  void *p = dlsym(RTLD_DEFAULT, n);
  if (!p) p = eglGetProcAddress(n);
  return p;
}
void som_gl_oes_init(void) {
  p_glGenFramebuffersOES = gl_oes("glGenFramebuffersOES");
  p_glBindFramebufferOES = gl_oes("glBindFramebufferOES");
  p_glDeleteFramebuffersOES = gl_oes("glDeleteFramebuffersOES");
  p_glFramebufferTexture2DOES = gl_oes("glFramebufferTexture2DOES");
  p_glCheckFramebufferStatusOES = gl_oes("glCheckFramebufferStatusOES");
  p_glGenRenderbuffersOES = gl_oes("glGenRenderbuffersOES");
  p_glBindRenderbufferOES = gl_oes("glBindRenderbufferOES");
  p_glDeleteRenderbuffersOES = gl_oes("glDeleteRenderbuffersOES");
  p_glRenderbufferStorageOES = gl_oes("glRenderbufferStorageOES");
  p_glFramebufferRenderbufferOES = gl_oes("glFramebufferRenderbufferOES");
  p_glBlendEquationOES = gl_oes("glBlendEquationOES");
}
static void w_glGenFramebuffersOES(int n, unsigned *a){ if(p_glGenFramebuffersOES) p_glGenFramebuffersOES(n,a); }
static void w_glBindFramebufferOES(unsigned t, unsigned f){ if(p_glBindFramebufferOES) p_glBindFramebufferOES(t,f); }
static void w_glDeleteFramebuffersOES(int n, const unsigned *a){ if(p_glDeleteFramebuffersOES) p_glDeleteFramebuffersOES(n,a); }
static void w_glFramebufferTexture2DOES(unsigned t, unsigned at, unsigned tt, unsigned tex, int l){ if(p_glFramebufferTexture2DOES) p_glFramebufferTexture2DOES(t,at,tt,tex,l); }
static unsigned w_glCheckFramebufferStatusOES(unsigned t){ return p_glCheckFramebufferStatusOES ? p_glCheckFramebufferStatusOES(t) : 0x8CD5; }
static void w_glGenRenderbuffersOES(int n, unsigned *a){ if(p_glGenRenderbuffersOES) p_glGenRenderbuffersOES(n,a); }
static void w_glBindRenderbufferOES(unsigned t, unsigned r){ if(p_glBindRenderbufferOES) p_glBindRenderbufferOES(t,r); }
static void w_glDeleteRenderbuffersOES(int n, const unsigned *a){ if(p_glDeleteRenderbuffersOES) p_glDeleteRenderbuffersOES(n,a); }
static void w_glRenderbufferStorageOES(unsigned t, unsigned f, int w, int h){ if(p_glRenderbufferStorageOES) p_glRenderbufferStorageOES(t,f,w,h); }
static void w_glFramebufferRenderbufferOES(unsigned t, unsigned a, unsigned rt, unsigned r){ if(p_glFramebufferRenderbufferOES) p_glFramebufferRenderbufferOES(t,a,rt,r); }
static void w_glBlendEquationOES(unsigned m){ if(p_glBlendEquationOES) p_glBlendEquationOES(m); }

/* ---- libc/BSD que faltam no glibc-target ---- */
static int som_register_atfork(void *a, void *b, void *c, void *d){ (void)a;(void)b;(void)c;(void)d; return 0; }
static size_t som_strlcpy(char *dst, const char *src, size_t sz){
  size_t n = strlen(src);
  if (sz) { size_t c = n < sz-1 ? n : sz-1; memcpy(dst, src, c); dst[c] = 0; }
  return n;
}
static size_t som_strlcpy_chk(char *dst, const char *src, size_t sz, size_t dstlen){ (void)dstlen; return som_strlcpy(dst, src, sz); }
/* SL_IID extras que o plandroid importa (dummies, como os do opensles_shim) */
static const void *som_SL_IID_EFFECTSEND = (void*)0xE1;
static const void *som_SL_IID_PLAYBACKRATE = (void*)0xE2;
...
DynLibFunction dynlib_functions[] = {
    ...
    /* ---- GLES1 fixed-function (Secret of Mana / plandroid) ---- */
    ...
    {"glGenRenderbuffersOES", (uintptr_t)&w_glGenRenderbuffersOES},
    {"glBindRenderbufferOES", (uintptr_t)&w_glBindRenderbufferOES},
    {"glDeleteRenderbuffersOES", (uintptr_t)&w_glDeleteRenderbuffersOES},
    {"glRenderbufferStorageOES", (uintptr_t)&w_glRenderbufferStorageOES},
    {"glFramebufferRenderbufferOES", (uintptr_t)&w_glFramebufferRenderbufferOES},
    {"glBlendEquationOES", (uintptr_t)&w_glBlendEquationOES},
    /* ---- zlib (link -lz) ---- */
    ...
    {"__register_atfork", (uintptr_t)&som_register_atfork},
    {"strlcpy", (uintptr_t)&som_strlcpy},
    {"__strlcpy_chk", (uintptr_t)&som_strlcpy_chk},
    {"stderr", (uintptr_t)&stderr},
    /* ---- OpenSLES IIDs extras ---- */
    {"SL_IID_EFFECTSEND", (uintptr_t)&som_SL_IID_EFFECTSEND},
    {"SL_IID_PLAYBACKRATE", (uintptr_t)&som_SL_IID_PLAYBACKRATE},
