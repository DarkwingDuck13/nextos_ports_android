#!/bin/bash
# LEGO Ninjago Tournament of Elements (Android so-loader, engine WB Fusion armeabi-v7a)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte legomovie.
...
GAMEDIR="/storage/roms/ports/ninjagotournament"
cd "$GAMEDIR"
...
./ninjagotournament >"$GAMEDIR/debug.log" 2>&1
