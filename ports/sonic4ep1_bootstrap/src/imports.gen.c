// imports.gen.c — GERADO por new-port-arm.sh para 'sonic4ep1_bootstrap' (libs3e_android.so)
...
DynLibFunction dynlib_functions[] = {
    {"__sonic4ep1_bootstrap_dummy__", 0}, /* sentinela; resolução real = dlsym+imports.c */
};
