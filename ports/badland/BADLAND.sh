#!/bin/bash
# BADLAND (Android so-loader, Cocos2d-x + FMOD Studio)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte badland (ports/badland).
...
GAMEDIR="/storage/roms/ports/badland"
cd "$GAMEDIR"
...
./badland "$GAMEDIR" >"$GAMEDIR/debug.log" 2>&1
