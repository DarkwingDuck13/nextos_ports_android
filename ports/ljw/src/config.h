...
// Jurassic World ships a single arm64 libProject_Amber_Mobile.so with a
// statically linked C++ runtime (no donor needed). v2.2.1.82
// (com.wb.goog.legojurassicworld). Same WB Games "Fusion" JNI surface as
// Ninjago / Star Wars TFA.
#define SO_NAME "libProject_Amber_Mobile.so"
...
#define PACKAGE      "com.wb.goog.legojurassicworld"
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.legojurassicworld/files"                       // getFilesDir
#define CACHE_PATH  "/data/user/0/com.wb.goog.legojurassicworld/cache"                       // getCacheDir
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.legojurassicworld/files"   // getExternalFilesDir
