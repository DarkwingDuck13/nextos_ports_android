#!/bin/bash
# LEGO Jurassic World (Android so-loader, engine Fusion)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte ninjago (ports/ljw).
...
GAMEDIR="/storage/roms/ports/ljw"
cd "$GAMEDIR"
