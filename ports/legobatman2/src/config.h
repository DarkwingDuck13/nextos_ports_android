...
// C++ runtime (no donor needed). v2.0.1.27 (com.wb.goog.legobdc).
#define SO_NAME "libLEGO_SH1.so"
...
#define PACKAGE      "com.wb.goog.legobdc"
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.legobdc/files"                       // getFilesDir
#define CACHE_PATH  "/data/user/0/com.wb.goog.legobdc/cache"                       // getCacheDir
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.legobdc/files"   // getExternalFilesDir
