# legobatman2 — NextOS Android port

Port gerado por `nextos_ports_android`. `.so`: `libLEGO_SH1.so`.

## Game files (BYO — você fornece, do seu APK legítimo)
- `libLEGO_SH1.so` (de lib/arm64-v8a/)
- assets / OBB conforme o jogo

## Estado
- [ ] Resolver UNKNOWN em src/imports.gen.c (39 símbolos)
