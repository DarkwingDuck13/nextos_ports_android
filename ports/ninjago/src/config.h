...
// Ninjago ships a single arm64 libLEGO_Pixel_Mobile.so with a statically linked
// C++ runtime (no donor needed). v2.1.1.02 (com.wb.goog.lnjgo).
#define SO_NAME "libLEGO_Pixel_Mobile.so"
...
#define PACKAGE      "com.wb.goog.lnjgo"
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.lnjgo/files"                       // getFilesDir
#define CACHE_PATH  "/data/user/0/com.wb.goog.lnjgo/cache"                       // getCacheDir
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.lnjgo/files"   // getExternalFilesDir
