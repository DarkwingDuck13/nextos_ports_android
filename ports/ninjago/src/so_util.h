...
// convenience globals for shims that want the loaded image extent (set by main
// after so_load): the .text/.so runtime base and total load size
...
// writable load_base mirror (for patching before so_finalize); 0 when missing
