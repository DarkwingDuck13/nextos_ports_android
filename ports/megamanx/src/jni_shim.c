...
#include <stdlib.h>
#include <stdarg.h>
#define ASSET_BASE "/storage/roms/megamanx/"
...
static void *jni_CallObjectMethodV(void *env, void *obj, void *methodID,
  ...
  if (nm) {
    ...
    if (strcmp(nm, "getAssetPackPath") == 0)
      return make_jstring("/storage/roms/megamanx");
    ...
    if (strcmp(nm, "getFilesDir") == 0 || strcmp(nm, "getExternalFilesDir") == 0 ||
      ...
      return make_jstring("/storage/roms/megamanx/userdata");
...
static unsigned char jni_CallBooleanMethodV(void *env, void *obj,
  ...
  if (nm) {
    ...
    if (strcmp(nm, "getBoolean") == 0) {
      ...
      /* MMX_PREFSTRUE: retorna true p/ TODA pref booleana -> o BootScene pula Termos/Controle
         Parental ("já aceito/já feito") e prossegue p/ carregar a cena. */
