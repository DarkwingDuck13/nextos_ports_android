...
#define ASSET_BASE_M "/storage/roms/ff9/"
...
static int my_statfs64(const char *p, void *buf) {
  ...
  int rc = real ? real("/storage/roms/ff9", buf) : -1;
 ...
 * em /storage/roms/ff9/shot.ppm (verificação autônoma de IMAGEM no fbdev Mali). */
static void ter_screenshot_maybe(void) {
  ...
  FILE *f = fopen("/storage/roms/ff9/shot.ppm","wb");
  if (f) { fprintf(f,"P6\n%d %d\n255\n", w, h);
...
/* il2cpp C API resolvido por NOME (os offsets variam por build do il2cpp; o Terraria
...
static void *choreo_driver_thread(void *arg) {
  ...
  /* il2cpp_domain_get/il2cpp_thread_attach resolvidos por nome no F1 (símbolos exportados). */
  if (il2_domain_get && il2_thread_attach) {
...
int main(int argc, char **argv) {
  ...
  jni_shim_set_package("com.square_enix.FFIXww.android_googleplay", 0);
  ...
  patch_got("__FD_SET_chk", (void *)my_FD_SET_chk);
    ...
    /* il2cpp C API por NOME (il2cpp é o módulo ATIVO aqui) — usado pelo choreo driver
       e helpers; substitui os offsets hardcoded do Terraria que no FF9 são dados. */
    { extern void *(*il2_domain_get)(void); extern void *(*il2_thread_attach)(void *);
      il2_domain_get = (void *(*)(void))so_find_addr_safe("il2cpp_domain_get");
      il2_thread_attach = (void *(*)(void *))so_find_addr_safe("il2cpp_thread_attach");
      fprintf(stderr, "[F1] il2cpp API: domain_get=%p thread_attach=%p\n",
              (void *)il2_domain_get, (void *)il2_thread_attach); }
    so_finalize(); so_flush_caches();
