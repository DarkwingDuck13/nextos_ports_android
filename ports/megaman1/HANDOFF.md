...
- **PRÓXIMO (ordem)**: (1) **ÁUDIO/banks Cricket** — Cricket abre asset via JNI Java AssetManager (0 chamadas ao nosso AAssetManager_open); fazer carregar via FILESYSTEM (CkPathType) OU implementar o JNI de asset; pode DESBLOQUEAR o controle. (2) revalidar controle gameplay. (3) empacotar launcher ES + gptokeyb. (4) reusar base p/ MM2-6 (APKs em ~/Downloads).
