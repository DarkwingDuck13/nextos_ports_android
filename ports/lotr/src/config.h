 ...
 *
 * LEGO The Lord of the Rings (Android, armeabi-v7a) on Mali-450.
 * The game lib is libLEGO_LOTR.so (WB Games "Fusion" engine, same JNI surface
...
// armeabi-v7a (softfp) libLEGO_LOTR.so, GLES2. v1.05.1 (com.wb.goog.llotr).
#define SO_NAME "libLEGO_LOTR.so"
...
#define PACKAGE  "com.wb.goog.llotr"
#define OBB_FILE "main.1051.com.wb.goog.llotr.obb"   // relative to the game dir
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.llotr/files"
#define CACHE_PATH  "/data/user/0/com.wb.goog.llotr/cache"
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.llotr/files"
