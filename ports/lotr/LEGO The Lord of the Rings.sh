#!/bin/bash
# LEGO The Lord of the Rings (Android so-loader, engine WB Fusion armeabi-v7a)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte lotr (ports/lotr).
...
GAMEDIR="/storage/roms/ports/lotr"
cd "$GAMEDIR"
