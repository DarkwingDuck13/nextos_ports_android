#!/bin/bash
# LEGO Marvel Super Heroes (Android so-loader, engine Fusion)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte ninjago (ports/marvel).
...
GAMEDIR="/storage/roms/ports/marvel"
cd "$GAMEDIR"
