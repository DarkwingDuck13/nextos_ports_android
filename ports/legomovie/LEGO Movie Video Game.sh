#!/bin/bash
# LEGO Movie Video Game (Android so-loader, engine WB Fusion armeabi-v7a)
# -> Mali-450 fbdev (NextOS Amlogic-old). Loader: fonte legomovie (base lotr).
...
GAMEDIR="/storage/roms/ports/legomovie"
cd "$GAMEDIR"
...
./legomovie >"$GAMEDIR/debug.log" 2>&1
