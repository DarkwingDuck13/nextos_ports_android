...
**PRÓXIMOS PASSOS:** validar resposta in-game do controle (NextOS), lag (comparar c/ DYSMANTLE_NO_OBOE=1),
...
**SINTOMAS (NextOS):** chega no gameplay 100%, controle perfeito, mas: chão BRANCO;
