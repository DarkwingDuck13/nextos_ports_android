 ...
 *
 * LEGO Batman 3: Beyond Gotham (Android, arm64) on Mali-450.
 * The game lib is libLEGO_Black_Mobile.so (WB Games "Fusion" engine, same JNI
...
// Batman 3 ships a single arm64 libLEGO_Black_Mobile.so with a statically linked
// C++ runtime (no donor needed). v2.2.1.05 (com.wb.goog.lbbg).
...
#define PACKAGE      "com.wb.goog.lbbg"
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.lbbg/files"                       // getFilesDir
#define CACHE_PATH  "/data/user/0/com.wb.goog.lbbg/cache"                       // getCacheDir
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.lbbg/files"   // getExternalFilesDir
