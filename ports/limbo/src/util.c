...
const char *resolve_android_path(const char *path) {
  ...
  static const char *app_data_prefix = "/data/data/com.playdead.limbo.full/";
  static const char *app_data_prefix_2 = "/data/user/0/com.playdead.limbo.full/";
  static const char *sdcard_prefix =
      "/storage/emulated/0/Android/data/com.playdead.limbo.full/";
