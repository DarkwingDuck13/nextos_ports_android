 ...
 *
 * LEGO Harry Potter Years 1-4 (Android, armv7) on Mali-450.
 * The game lib is libLEGOHarry.so (WB Games "Fusion" engine, same JNI
...
// Ninjago ships a single arm64 libLEGOHarry.so with a statically linked
// C++ runtime. v1.06.4 (com.wb.goog.legohp1). armeabi-v7a + GLES1.
#define SO_NAME "libLEGOHarry.so"
...
#define PACKAGE      "com.wb.goog.legohp1"
#define GAMEDATA_DIR "gamedata"   // loose extracted assets, relative to the game dir
// OBB registered via addOBBEntriesToFusion: obbDir/OBB_FILE opened by the engine.
#define OBB_DIR      "."
#define OBB_FILE     "main.1062.com.wb.goog.legohp1.obb"
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.legohp1/files"                       // getFilesDir
#define CACHE_PATH  "/data/user/0/com.wb.goog.legohp1/cache"                       // getCacheDir
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.legohp1/files"   // getExternalFilesDir
