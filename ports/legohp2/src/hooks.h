/* hooks.h -- LEGO Harry Potter 5-7 (libLEGO_HP2.so) hook surface (GLES1)
 *
 ...
 * glGetString is wrapped (the engine deref's the result). The single-context
...
// engine-level patches applied to the loaded libLEGO_HP2.so
