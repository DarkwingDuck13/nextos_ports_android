...
// GLES1 float entry points are provided by softfp_shim.c (sf_glClearColor,
// sf_glFogf, sf_glLightf, sf_glMaterialf, sf_glTexEnvf, sf_glNormal3f,
// sf_glAlphaFunc, sf_glClearDepthf, sf_glDepthRangef) -- softfp(aapcs) wrappers
// that forward to the hardfp system libGLESv1_CM.
...
DynLibFunction dynlib_functions[] = {
  ...
  // GLES1 -- non-float bind direct to the system libGLESv1_CM
  ...
  // GLES1 float args -> softfp wrappers (softfp_shim.c)
