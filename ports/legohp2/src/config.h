 ...
 *
 * LEGO Harry Potter: Years 5-7 (Android, armeabi-v7a) on Mali-450.
 * The game lib is libLEGO_HP2.so (WB Games "Fusion" engine, older 2016 build,
 * same family as LEGO The Lord of the Rings but rendering via GLES1
 * fixed-function -- NEEDED libGLESv1_CM, no shaders). Driven through the
...
// armeabi-v7a (softfp) libLEGO_HP2.so, GLES1. v1.05.1 (com.wb.goog.legohp2).
#define SO_NAME "libLEGO_HP2.so"
...
#define PACKAGE  "com.wb.goog.legohp2"
#define OBB_FILE "main.1051.com.wb.goog.legohp2.obb"   // relative to the game dir
...
#define SAVE_PATH   "/data/user/0/com.wb.goog.legohp2/files"
#define CACHE_PATH  "/data/user/0/com.wb.goog.legohp2/cache"
#define WRITE_PATH  "/storage/emulated/0/Android/data/com.wb.goog.legohp2/files"
